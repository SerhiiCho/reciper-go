    ...
    var Dropdown = function (_Component2) {
        ...
        function Dropdown(el, options) {
            ...
            */
            ...
            // Move dropdown after dropdown-trigger
        ...
        _createClass(Dropdown, [{
            ...
            */
            ...
            value: function _handleMouseLeave(e) {
                ...
                var leaveToDropdownContent = !!$(toEl).closest('.dropdown').length;
                ...
                // Close hover dropdown if mouse did not leave to either active dropdown-trigger or dropdown
            ...
            value: function _handleDocumentClick(e) {
                ...
                var $target = $(e.target);
                if (this.options.closeOnClick && $target.closest('.dropdown').length && !this.isTouchMoving) {
                    // isTouchMoving to check if scrolling on mobile.
                    setTimeout(function () {
                        _this9.close();
                    }, 0);
                } else if ($target.closest('.dropdown-trigger').length || !$target.closest('.dropdown').length) {
                    setTimeout(function () {
                        _this9.close();
                    }, 0);
                }
...
;(function ($, anim) {
    $(document).on('click', '.card', function (e) {
        if ($(this).children('.card-reveal').length) {
            ...
            if ($(e.target).is($('.card-reveal .activator')) || $(e.target).is($('.card-reveal .activator i'))) {
